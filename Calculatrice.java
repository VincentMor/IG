...
public class Calculatrice extends Application
{
    ...
    public void start (Stage Plateau)
    {
      ...
      touche7.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"7");});
      Button touche8=new Button("8");
      touche8.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"8");});
      Button touche9=new Button("9");
      touche9.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"9");});
      ...
      touchePlus.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"+");});
      Button touche4=new Button("4");
      touche4.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"4");});
      Button touche5=new Button("5");
      touche5.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"5");});
      Button touche6=new Button("6");
      touche6.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"6");});
      Button toucheMoins=new Button("-");
      toucheMoins.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"-");});
      ...
      touche1.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"1");});
      Button touche2 =new Button("2");
      touche2.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"2");});
      Button touche3=new Button("3");
      touche3.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"3");});
      Button toucheFois=new Button("*");
      toucheFois.setOnAction((ActionEvent Evenement) -> {Message.setText(Message.getText()+"*");});
      ...
      toucheE.setOnAction((ActionEvent Evenement) -> {Message.setText("");});
